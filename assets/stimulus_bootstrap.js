...
import BasketItemsCollectionController from './controllers/basket_items_collection_controller';

const app = Application.start();
app.register('basket-item-toggle', BasketItemToggleController)
app.register('basket-reorder', BasketReorderController)
app.register('basket-items-collection', BasketItemsCollectionController)
